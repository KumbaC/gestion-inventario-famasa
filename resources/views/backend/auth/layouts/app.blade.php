        ...
        <div class="relative flex flex-col flex-1 overflow-x-hidden overflow-y-auto">
            ...
            <main>
                <div class="relative flex flex-col justify-center w-full h-screen dark:bg-gray-900 sm:p-0 lg:flex-row">
                    ...
                    <div
                        class="relative items-center hidden w-full h-full bg-brand-500 dark:bg-white/5 lg:grid lg:w-1/2">
                        <div class="flex items-center justify-center z-1">
                            ...
                            <div class="flex flex-col items-center max-w-xl">
                                <a href="#" class="block mb-4">
                                    <img src="{{ asset('images/logo/1000236628_background.png') }}" alt="Logo">
                                </a>
                                <p class="text-center text-gray-400 dark:text-white/60">
                                    {{ __('Gestión de Inventario | Inversiones Famasa') }}
                                </p>
                            </div>
                        </div>
                    </div>
