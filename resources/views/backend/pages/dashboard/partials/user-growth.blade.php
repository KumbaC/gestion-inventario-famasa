@php $currentFilter = request()->get('chart_filter_period', 'Ultimos 12 meses'); @endphp
                    ...
                    <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefaultButton">
                        <li>
                            <a href="{{ route('admin.dashboard') }}?chart_filter_period=last_12_Months"
                                ...
                                <span class="ml-2"> {{ __('Últimos 12 meses') }}</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('admin.dashboard') }}?chart_filter_period=this_year"
                                ...
                                <span class="ml-2"> {{ __('Este año') }}</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('admin.dashboard') }}?chart_filter_period=last_year"
                                ...
                                <span class="ml-2"> {{ __('Último año') }}</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('admin.dashboard') }}?chart_filter_period=last_30_days"
                                ...
                                <span class="ml-2"> {{ __('Últimos 30 días') }}</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('admin.dashboard') }}?chart_filter_period=last_7_days"
                                ...
                                <span class="ml-2"> {{ __('Últimos 7 días') }}</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('admin.dashboard') }}?chart_filter_period=this_month"
                                ...
                                <span class="ml-2"> {{ __('Este mes') }}</span>
                            </a>
                        </li>
                    </ul>
                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (currentFilter === 'last_6_months') {
                ...
                chartCategories = (userGrowthLabels || ['ENE', 'FEB', 'MAR', 'ABR', 'MAY', 'JUN']).slice(-6);
                ...
                const thisYearLabels = ['ENE', 'FEB', 'MAR', 'ABR', 'MAY', 'JUN', 'JUL', 'AGO', 'SEP', 'OCT', 'NOV',
                    'DIC'
                ...
                chartCategories = userGrowthLabels || ['ENE', 'FEB', 'MAR', 'ABR', 'MAY', 'JUN', 'JUL', 'AGO',
                    'SEP', 'OCT', 'NOV', 'DIC'
                ];
