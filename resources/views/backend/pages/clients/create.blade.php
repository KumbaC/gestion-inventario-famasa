                    ...
                    <form action="{{ route('admin.clients.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                            ...
                            <div>
                                ...
                                <input type="text" name="identification" id="identification" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300" required>
                            </div>
                        ...
                        <div class="mt-6">
                            <button type="submit" class="btn-primary">{{ __('Crear Cliente') }}</button>
