                            ...
                            @foreach ($sales as $sale)
                                <tr>
                                   ...
                                   <td class="border px-4 py-2" style="width: 150px;">{{ $sale->client->name }}</td>
                                    ...
                                    <td class="border px-4 py-2">@if($sale->amount_foreign_currency) {{ number_format($sale->amount_foreign_currency, 2) }} {{ $sale->typeCoin->symbol }} @else {{ 'N/A' }}@endif</td>
                                    <td class="border px-4 py-2">@if($sale->exchange_rate) {{ number_format($sale->exchange_rate, 2) }} {{ $sale->typeCoin->symbol }} @else {{ 'N/A' }}@endif</td>
                                    <td class="border px-4 py-2">{{ $sale->amount }} {{ 'USD' }}</td>
                                    
                                    <td class="border px-4 py-2">@if($sale->amount_total == $sale->amount.' USD') 0 USD @else {{ $sale->return_change }} {{ 'USD' }}@endif</td>
